        ...
        ScrollView(.vertical, showsIndicators: false) {
            VStack(spacing: 15) {
                ...
                VStack(spacing: 15){
                    ...
                    Text(expenseViewModel.convertExpensesToCurrency(expenses: expenseViewModel.expenses, type:
                        expenseViewModel.tabName))
                    .font(.title.bold())
                    .opacity(0.9)
            ...
            if expenseViewModel.showFilterView{
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    DatePicker("", selection:
                                $expenseViewModel.startDate,in:
                                Date.distantPast...Date(), displayedComponents:
                                [.date])
                    .labelsHidden()
